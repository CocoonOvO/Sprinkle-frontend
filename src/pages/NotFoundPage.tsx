  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="relative z-10 text-center animate-float">
        <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-strawberry-400 to-strawberry-500 flex items-center justify-center mx-auto mb-6 shadow-xl hover-lift" style={{ boxShadow: '0 12px 32px rgba(236, 72, 153, 0.4)' }}>
          <span className="text-white font-bold text-5xl">404</span>
        </div>
        <h1 className="text-2xl font-bold text-chocolate-600 mb-2">页面未找到</h1>
        <p className="text-chocolate-400 mb-8">抱歉，您访问的页面不存在</p>
        <Link
          to="/"
