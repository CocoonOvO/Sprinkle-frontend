...
export const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  return (
    <div
      className={cn(
        'group flex gap-2 px-4 py-1 animate-[fadeIn_0.2s_ease-out]',
    ...
    >
      ...
      <div className={cn('flex flex-col gap-1 max-w-[70%]', isOwn && 'items-end')}>
        ...
        >
          ...
          {message.is_edited && (
            <span className="text-[10px] text-gray-400">(已编�?</span>
          )}
        </div>

        <div
          className={cn(
            'absolute top-1/2 -translate-y-1/2 flex items-center gap-1 bg-white rounded-full shadow-lg border p-1 transition-opacity',
